...
//------------------------------------------------------------
void floy::addForce(float x, float y){
...
//------------------------------------------------------------
void floy::addRepulsionForce(float x, float y, float radius, float scale){
...
//------------------------------------------------------------
void floy::addAttractionForce(float x, float y, float radius, float scale){
...
//------------------------------------------------------------
void floy::addRepulsionForce(floy &p, float radius, float scale){
	
	// ----------- (1) make a vector of where this floy p is: 
	ofVec2f posOfForce;
...
//------------------------------------------------------------
void floy::addAttractionForce(floy & p, float radius, float scale){
...
//------------------------------------------------------------
void floy::addClockwiseForce(floy &p, float radius, float scale){
...
//------------------------------------------------------------
void floy::addCounterClockwiseForce(floy &p, float radius, float scale){
...
//------------------------------------------------------------
void floy::addForFlocking(floy &p){
...
//------------------------------------------------------------
void floy::setInitialCondition(float px, float py, float vx, float vy){
    pos.set(px,py);
	vel.set(vx,vy);
}
